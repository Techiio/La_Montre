...
<header class="header">
    ...
    ?>
        <a href="user-gest-admin_menu.php" class="logo">
...
<section class="inscri" id="inscri">
    ...
    <h1 class="heading"> C<span>G</span>U</h1>
...
LaMontre-Eko.fr se réserve le droit de modifier unilatéralement et à tout moment le contenu des
présentes CGU.

Article 1 : Les mentions légales

L’édition et la direction de la publication du site LaMontre-Eko.fr est assurée par Darson Simon,
domicilié 28 Rue Notre Dame des Champs.
Numéro de téléphone est 01 49 54 52 00
Adresse e-mail simon.darson@eleve.isep.fr.
L'hébergeur du site LaMontre-Eko.fr est la société Azure, dont le siège social est situé au 39 QUAI DU
PRESIDENT ROOSEVELT, avec le numéro de téléphone : _______________.

ARTICLE 2 : Accès au site

Le site LaMontre-Eko.fr permet à l'Utilisateur un accès gratuit aux services suivants :
Le site internet propose les services suivants :
Interface de montre connectée sur la santé
...
la responsabilité de LaMontre-Eko.fr. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
...
La marque LaMontre est une marque déposée par THOMAS Benoit.Toute représentation et/ou
...
Les sources des informations diffusées sur le site LaMontre-Eko.fr sont réputées fiables mais le site
...
Malgré des mises à jour régulières, le site LaMontre-Eko.fr ne peut être tenu responsable de la
...
Le site LaMontre-Eko.fr ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
...
liens, il sortira du site LaMontre-Eko.fr. Ce dernier n’a pas de contrôle sur les pages web sur
...
l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site LaMontre-Eko.fr. Les
...
L’information contenue dans les cookies est utilisée pour améliorer le site LaMontre-Eko.fr.
